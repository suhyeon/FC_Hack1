(function(window,document){
  ...
  function insertItem(element, str){
    todoList.insertAdjacentHTML('beforeend', '<li class="todo-item">' + str + '<button class="delete">삭제</button></li>');
    deleteItem();
  }
  function deleteItem(){
  ...
  button.addEventListener('click' , evenList);
  input.addEventListener('keyup', evenList);
